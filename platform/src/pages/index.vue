...
<script>
	...
	export default {
		...
		created(){
			...
			.then(res => this.newsList = res.data, err => console.log(err))
			this.$http.get('api/getBoardList')
			.then(res => this.boardList = res.data, err => console.log(err))
			this.$http.get('api/getProductList')
			.then(res => this.productList = res.data, err => console.log(err))
			// this.$http.get('api/getSlides')
			// .then(res => this.slides = res.data, err => console.log(err))
		},
		data(){
			return {
				invTime: 2000,
